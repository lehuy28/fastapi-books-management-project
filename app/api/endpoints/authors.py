...
def list_authors(
    ...
    """
    Get list authors, paginate use skip/limit
    """
...
def create_author(
    ...
    """Create new author. Check unique name """
...
@router.put("/{author_id}", response_model=Author, status_code=status.HTTP_201_CREATED)
def update_author(
    author_id : int,
    ...
    if author_up.description is not None:
        author.description = author_up.description
